...
/**
 * FreecamV2 - client-side only camera movement for visuals.
 * Player remains in original position/rotation server-side.
 * This module DOES NOT send movement/interaction packets.
 */
public class FreecamV2 extends Module {
    ...
    public FreecamV2() {
        super(Categories.Render, "freecam-v2", "Allows the camera to move away from the player (client-side only).");
    }
