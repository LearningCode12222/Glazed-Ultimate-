...
public class FreecamV2 extends Module {
    ...
    public void onActivate() {
        ...
        // Clone player for visual stand-in
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        Vec3d move = forwardVec.multiply(forward).add(strafeVec.multiply(strafe)).normalize().multiply(speed.get());
    ...
    private void onInteract(InteractEvent event) {
        // Block all interactions while freecamming
        event.cancel();
    }
}
